...
const Home = () => {
  ...
  'HINDUNILVR.NS', 'WIPRO.NS', 'ITC.NS', 'BHARTIARTL.NS', 'ASIANPAINT.NS',
  'ADANIENT.NS', 'ADANIPORTS.NS', 'MARUTI.NS', 'LT.NS', 'DMART.NS',
  'KOTAKBANK.NS', 'TECHM.NS', 'COALINDIA.NS', 'ONGC.NS', 'POWERGRID.NS',
  'SUNPHARMA.NS', 'HCLTECH.NS', 'ULTRACEMCO.NS', 'NTPC.NS', 'BAJAJ-AUTO.NS',
  'HEROMOTOCO.NS', 'TITAN.NS', 'GRASIM.NS', 'BPCL.NS', 'HINDALCO.NS',
  'VEDL.NS', 'SBILIFE.NS', 'ICICIPRULI.NS', 'TATASTEEL.NS', 'BRITANNIA.NS'
  ];
